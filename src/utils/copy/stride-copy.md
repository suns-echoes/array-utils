strideCopy
----------
<!-- DEFINE @_SHORT_DESC="copy strides from source array into destination array" -->
...
| defaultValue | `number` | Optional value to put in empty spaces (between block end and stride end). |
